...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#1E293B', color: '#F8FAFC' },
          active: { scale: 1.1, backgroundColor: '#0D9488', color: '#0D9488' },
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { scaleX: 1, backgroundColor: '#0D9488' }
  };
  ...
  return (
    <svg {...props} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      <motion.path
        ...
        transition={{ delay: 0.15, type: 'spring', stiffness: 200, damping: 20, duration: 0.5 }}
        strokeLinecap="round"
